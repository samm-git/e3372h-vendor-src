...
TARGET_OUT_HW_APPS := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_APP)
TARGET_OUT_APPS_EXECUTABLES:= $(TARGET_OUT_HW_APPS)/bin
TARGET_OUT_APPS_SHARED_LIBRARIES:= $(TARGET_OUT_HW_APPS)/lib
