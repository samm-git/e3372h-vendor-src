...
IF_ATP_FTP(APPLET_ODDNAME(ftpget, ftpgetput, BB_DIR_BIN, BB_SUID_DROP, ftpget))
IF_ATP_FTP(APPLET_ODDNAME(ftpput, ftpgetput, BB_DIR_BIN, BB_SUID_DROP, ftpput))
IF_ATP_TFTP(APPLET(tftp, BB_DIR_BIN, BB_SUID_DROP))
IF_ATP_TRACEROUTE6(APPLET(traceroute6, BB_DIR_BIN, BB_SUID_DROP))
IF_ATP_WGET(APPLET(wget, BB_DIR_BIN, BB_SUID_DROP))
IF_ATP_PING(APPLET(ping, BB_DIR_BIN, BB_SUID_DROP))
