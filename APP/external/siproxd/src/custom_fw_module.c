 ...
 * to happen.
 *2121101411  s00201037  2012/12/25        fortify«Â¡„
 */
...
static char const ident[]="$Id: custom_fw_module.c,v 1.1 2008/02/19 07:51:51 y42304 Exp $";
...
int custom_fw_control(fw_ctl_t fwdata) {
   ...
   snprintf(&tmp[strlen(tmp)],256,"[lcl %s:%i] ",
           utils_inet_ntoa(fwdata.local_ipaddr),
           fwdata.local_port);

   snprintf(&tmp[strlen(tmp)],256,"[rem %s:%i] ",
