...
/******************************************************************************
	...
	3092906251  s00201037  2013/10/15              增加sipdns域名解析
	4032002611  l84014339  2013/03/21              在get_ip_by_host函数中添加点分十进制的IP判断功能
******************************************************************************/
#include "config.h"
...
/******************************************************************************
  函数名称  : CheckSubnet
  功能描述  : 检查源ip与目的ip是否在同一个网段
  输入参数  : uint32 src, uint32 dst, uint32 mask
...
/******************************************************************************
  函数名称  : ParseIpInfo
  功能描述  : 解析conntrack udp行数据
  输入参数  : int8 *pinput, uint32 *psrc,
...
/******************************************************************************
  函数名称  : GetConntrackInfo
  功能描述  : 获得五元组
  输入参数  : int8 *p, Ip_Rule_Info_ST *piprunleinfo
...
/******************************************************************************
  函数名称  : GetConntrackDstIp
  功能描述  : 读/proc/net/ip_conntrack文件进行逐行分析，
              查找与之对应的dstip
  输入参数  :
