...
/* $Id: util.c 92 2012-04-16 08:47:26Z sgroarke $
 * $HeadURL: https://npd6.googlecode.com/svn/trunk/util.c $
 */
...
#define NPD6PROXY_SERVER_DEBUG(msg, args...)  
//*******************************************************
 ...
 */
#if 0
void tDump(const void *nodep, const which, const int depth)
{
