 ...
 */
 /**********************问题单修改记录******************************************
    日期              修改人         问题单号           修改内容
 2013.06.28        y00188255      3061302357     合入安全漏洞
 2013.08.13        y00188255      3081301488     使用单板上电时间代替系统时间
******************************************************************************/
	...
	struct sockaddr_in6 *addr)
{
	...
	/* BEGIN 3081301488 y00188255 2013/8/13  Added */
	struct timespec ts;
 	/* END 3081301488 y00188255 2013-8-13  Added */
	...
	if (iface->UnicastOnly) {
        /* BEGIN 3061302357 y00188255 2013-6-28  deleted */
		//mdelay(delay);
        /* END 3061302357 y00188255 2013-6-28  deleted */
	...
	struct sockaddr_in6 *addr)
{
	...
	while (len > 0)
	{
		...
		case ND_OPT_MTU:
            ...
            /* BEGIN 3061302357 y00188255 2013-6-28  added */
			if (len < sizeof(*mtu))
				return;
            /* END 3061302357 y00188255 2013-6-28  added */
