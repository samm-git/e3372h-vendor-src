...
# V7R2 platform 
ifneq ($(findstring MBB_PLATFORM_V7R2, $(APP_DEFINE)),)
L_CFLAGS += -DMBB_PLATFORM_V7R2
endif
# VSDB FEATURE
ifneq ($(findstring FEATURE_MBB_WIFI_VSDB, $(APP_DEFINE)),)
L_CFLAGS += -DFEATURE_MBB_WIFI_VSDB
endif
#QCA6174 chip
ifneq ($(findstring FEATURE_HUAWEI_MBB_QCA6174, $(APP_DEFINE)),)
L_CFLAGS += -FEATURE_HUAWEI_MBB_QCA6174
endif
...
L_CFLAGS += -DCONFIG_CTRL_IFACE_CLIENT_DIR=\"/var/run/\"
...
INCLUDES += $(TARGET_OUT_HEADERS)/netplatform/netplatform/include
INCLUDES += $(TARGET_OUT_HEADERS)/include
INCLUDES += $(TARGET_OUT_HEADERS)/netplatforminc
else
INCLUDES += $(LOCAL_PATH)/../../../netplatform/include
INCLUDES += $(LOCAL_PATH)/../../../../include
INCLUDES += $(LOCAL_PATH)/../../../../netplatforminc
endif

ifdef CONFIG_DRIVER_NL80211
#INCLUDES += external/libnl-headers
INCLUDES += external/libnl_2/external/libnl-headers/
endif
...
LOCAL_SHARED_LIBRARIES := libc libcutils liblog libpublicapi
...
LOCAL_SHARED_LIBRARIES += libpublicapi libdl
