...
//w00176398 add for multi ssid unicast probe scan & broadcast scan
typedef enum
{
    DEFAULT_SSID_SCAN_FLAG = 0,
    BROADCAST_SSID_SCAN_FLAG = 1,
    MULTI_UNICAST_SSID_SCAN_FLAG = 2,
    MULTI_UNICAST_BROADCAST_SSID_SCAN_FLAG = 3
}SCAN_TYPE;

#define CSCAN_MAXNUM     9
#define CSCAN_MINNUM     1
...
#define WILDCARD_SSID_SCAN ((struct wpa_ssid *) 1)
	...
	/* BEGIN PN: 2070307199, Modified by l00182072, 2012/7/7*/
	//w00176398 add for setting scan flag
	int scan_flag;
	/* END   PN: 2070307199, Modified by l00182072, 2012/7/7*/

	/*BEGIN PN: 3032100903  2013/05/24  by shenxiong    ADD */
	/* record the channel set for scan */
	struct scan_channel channels;
  /*END PN: 3032100903  2013/05/24  by shenxiong    ADD */
};
