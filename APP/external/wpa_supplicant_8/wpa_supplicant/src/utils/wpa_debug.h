...
/******************************************************************************
修改日期          修改人        问题单号                 简要描述
2014/07/16        s00208871     4071605433         修改log输出的模块关键字
******************************************************************************/
#ifndef WPA_DEBUG_H
#define WPA_DEBUG_H
...
#ifdef ANDROID
#define WPA_SUPPLICANT_SDT_LOG
#endif
#ifdef WPA_SUPPLICANT_SDT_LOG
#include "np_log.h"
typedef enum
{
	OM_DEBUG_ERROR = 1,
...
#define wpa_printf(level, msg, args...)  do { \
    switch(level) \
    { \
    case MSG_ERROR: \
        NP_LOG_ERROR(ANDROID_LOG_NAME, msg" \n", ##args); \
        break;  \
    case MSG_WARNING: \
        NP_LOG_WARN(ANDROID_LOG_NAME, msg" \n", ##args); \
        break; \
    case MSG_INFO: \
        NP_LOG_DEBUG(ANDROID_LOG_NAME, msg" \n", ##args); \
        break; \
    case MSG_DEBUG: \
    case MSG_MSGDUMP: \
        NP_LOG_DEBUG(ANDROID_LOG_NAME, msg" \n", ##args); \
