...
2014/06/10      s00208871     4061001259         增加与hostapd的通信接口适配
******************************************************************************/
#ifndef WPA_CTRL_H
#define WPA_CTRL_H
...
typedef enum 
{
    WPA_SUPPLICANT_PRV_DISCONNECTED,
    WPA_SUPPLICANT_PRV_CONNECTED,
    WPA_SUPPLICANT_PRV_CONNECTING,
    WPA_SUPPLICANT_PRV_WPSPBCING
}WPA_SUPPLICANT_PRIVATE_STATE;
