...
typedef enum
{
	WPA_4WAY_HANDSHAKE_FLAG_FAILED = -1,
	WPA_4WAY_HANDSHAKE_FLAG_SUCCESS
}WPA_4WAY_HANDSHAKE_FLAG;

#define WPA_4WAY_HANDSHAKE_FAILED_REASON_CODE 15
...
struct wpa_driver_ops {
	 ...
	 */
	int (*combo_scan)(void *priv, struct wpa_driver_scan_params *params);
  	/**
...
/* support specified channels for scan */
enum BAND{
  BAND_24G = 0,
  BAND_5G,
  BAND_TOTAL
...
struct scan_channel{
   Boolean status;
   unsigned long long ch_set[BAND_TOTAL];
};
