...
/********************************************************************************************
修改日期        修改人        问题单号                 简要描述
2013/07/25     s00208871     3062608710        解决异频FW WPA PSK接入问题，先设置单播密钥,再发送4/4 key
********************************************************************************************/
					  ...
					  u16 ver)
{
    ...
    /*BEGIN PN: 3062608710,Added by s00208871, 2013/7/23*/  
#ifdef FEATURE_MBB_WIFI_VSDB
    if (key_info & WPA_KEY_INFO_INSTALL) {
      wpa_printf(MSG_WARNING, "install key before sending 4/4 key");
		if (wpa_supplicant_install_ptk(sm, key))
			goto failed;
	}
#endif /*FEATURE_MBB_WIFI_VSDB*/
  /*END PN: 3062608710,Added by s00208871, 2013/7/23*/  
	...
	sm->renew_snonce = 1;
  /*BEGIN PN: 3062608710,Added by s00208871, 2013/7/23*/ 
#ifndef FEATURE_MBB_WIFI_VSDB
	if (key_info & WPA_KEY_INFO_INSTALL) {
    wpa_printf(MSG_WARNING, "install key after sending 4/4 key");
		if (wpa_supplicant_install_ptk(sm, key))
			goto failed;
	}
#endif /*FEATURE_MBB_WIFI_VSDB*/	 
