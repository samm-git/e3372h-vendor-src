 ...
 */
#define AUTOCONF_TIMESTAMP "2014-07-29 13:49:15 CST"
...
#define ENABLE_MTDUTILS 1
#define IF_MTDUTILS(...) __VA_ARGS__
#define IF_NOT_MTDUTILS(...)
#undef CONFIG_REBTEST
#define ENABLE_REBTEST 0
#define IF_REBTEST(...)
#define IF_NOT_REBTEST(...) __VA_ARGS__
