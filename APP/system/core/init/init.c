 ...
 */
 ...
 /**********************问题单修改记录******************************************
日    期              修改人         问题单号                   修改内容
2014/06/05          l00212897     DTS2014053100140      可靠性项目添加启动模式检测
******************************************************************************/
...
/********************************************************************
*Function    : read_hwtest_mode
*Description : get hwtest mode
*Input       : none
*Output      : none
*Return      : mode

********************************************************************/
static int read_hwtest_mode()
{

    char* hwtest_name = "/proc/hwtest_mode";
    int hwtest_fd = -1;
    int ret = -1;
    int hwtest_mode = -1;

    hwtest_fd = open(hwtest_name, O_RDWR);
    ...
    ret = read(hwtest_fd,&hwtest_mode,sizeof(int));
...
int main(int argc, char **argv)
{
    ...
    hwtest_mode = read_hwtest_mode();

    INFO("reading config file\n");
    if(1 == hwtest_mode)
    {
        init_parse_config_file("/inithwtest.rc");
    }
    else
    {
