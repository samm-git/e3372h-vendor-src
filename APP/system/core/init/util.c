...
#define MAX_MTD_PARTITIONS 64
#define MAX_MTD_INFO_SIZE 64 // 配置文件/proc/mtd中每一行（每个分区信息）最大长度
#define MAX_MTD_BUFF_SIZE ((MAX_MTD_PARTITIONS) * (MAX_MTD_INFO_SIZE))
