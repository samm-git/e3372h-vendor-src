...
#define OLED_ID0_GPIO        (GPIO_2_20)  /*oled id0*/
#define OLED_ID1_GPIO        (GPIO_2_22)  /*oled id1*/
#define OLED_CD_GPIO         (GPIO_2_8)   /*oled cd*/
...
#define SIM0_DETECT_GPIO     (GPIO_0_2)  /*sim detect*/
