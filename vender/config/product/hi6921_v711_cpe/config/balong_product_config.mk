# MD5: be4fcf478ebe69db97620c718eecbeb2
CFG_BALONG_OBUILD_VERSION:=10
CFG_PRODUCT_NAME                      :="v711_cpe"
CFG_PRODUCT_CFG_CHIP_SOLUTION_NAME    :="Balong"
CFG_BUILD_TYPE                        :=RELEASE
CFG_PRODUCT_VERSION                   :=V700R110C30B160
CFG_PRODUCT_VERSION_STR               :="V700R110C30B160"
CFG_PRODUCT_FULL_VERSION_STR          :="Balong V700R110C30B160"
CFG_PRODUCT_FILE_VERSION_STR          :="2.1.6.8"
CFG_PRODUCT_DLOAD_SOFTWARE_VER		:= "24.816.01.00.00"
CFG_PRODUCT_CFG_DLOAD_KIND            :=FW_WEBUI
CFG_PRODUCT_CFG_DLOAD_ID              :=BV7R11C
CFG_PRODUCT_CFG_DLOAD_NAME            :=P711s-CPE
CFG_PRODUCT_DLOAD_DASHBOARD_VER       :=UTPS22.001.20.00.03
...
CFG_OS_PATH :=config/product/hi6921_v711_cpe/os
...
CFG_LNV_PRO_NAME :=hi6921_v711_cpe
...
CFG_TTF_SKB_EXP := NO
CFG_GU_FEATURE_CONFIG_PATH :=config/product/hi6921_v711_cpe/include_gu
...
CFG_PRODUCT_CFG_PTABLE_VER_NAME          := "HI6921_V711_CPE"
...
CFG_MBB_PTABLE_FASTBOOT_LEN             :=(0x1c0000)
CFG_MBB_PTABLE_NVBACK_LEN               :=(0x200000)
CFG_MBB_PTABLE_NVDEFAULT_LEN            :=(0x200000)
CFG_MBB_PTABLE_NVIMAGE_LEN              :=(0x400000)
CFG_MBB_PTABLE_NVDLOAD_LEN              :=(0x400000)
CFG_MBB_PTABLE_NVUPDATE_LEN             :=(0x000000)
CFG_MBB_PTABLE_OEMINFO_LEN              :=(0x400000)
CFG_MBB_PTABLE_KERNEL_LEN               :=(0x800000)
CFG_MBB_PTABLE_KERNELBK_LEN             :=(0x800000)
CFG_MBB_PTABLE_LOGO_LEN                 :=(0x0)
CFG_MBB_PTABLE_M3IMAGE_LEN              :=(0x200000)
CFG_MBB_PTABLE_DSP_LEN                  :=(0x600000)
CFG_MBB_PTABLE_MISC_LEN                 :=(0x200000)
CFG_MBB_PTABLE_VXWORK_LEN               :=(0x2800000)
CFG_MBB_PTABLE_RESERVE1_LEN             :=(0x100000)
CFG_MBB_PTABLE_RESERVE2_LEN             :=(0x100000)
CFG_MBB_PTABLE_RESERVE3_LEN             :=(0x300000)
CFG_MBB_PTABLE_OM_LEN                   :=(0xC00000)
CFG_MBB_PTABLE_WEBSDK_LEN               :=(0x1900000)
CFG_MBB_PTABLE_WEBUI_LEN                :=(0x3000000)
CFG_MBB_PTABLE_SYSTEM_LEN               :=(0x6400000)
CFG_MBB_PTABLE_USERDATA_LEN             :=(0xA00000)
CFG_MBB_PTABLE_BBOU_LEN                 :=(0xB400000)
CFG_MBB_PTABLE_MMC_LEN                  :=(0x2D00000)
CFG_MBB_PTABLE_CACHE_LEN                :=(0x0)
CFG_MBB_PTABLE_RECVA_LEN                :=(0x0)
CFG_MBB_PTABLE_RECVB_LEN                :=(0x0)
...
CFG_ONCHIP_FASTBOOT_ADDR                := 0x5F700000
...
CFG_PRODUCT_CFG_MODEM_SOFTWARE_VER		:= "21.181.03.01.000"
...
MBB_KEY    :=    FEATURE_ON
MBB_MLOG    :=    FEATURE_OFF
MBB_CHARGE    :=    FEATURE_OFF
MBB_THERMAL_PROTECT    :=    FEATURE_OFF
...
MBB_CHG_PLATFORM_V7R2    :=    FEATURE_OFF
