# MD5: ef7a9159ba54ca7ac71a293f4900434e
CFG_BALONG_OBUILD_VERSION:=10
CFG_PRODUCT_NAME                      :="v711_hilink"
CFG_PRODUCT_CFG_CHIP_SOLUTION_NAME    :="Balong"
CFG_BUILD_TYPE                        :=RELEASE
CFG_PRODUCT_VERSION                   :=V700R110C00B060
CFG_PRODUCT_VERSION_STR               :="V700R110C00B060"
CFG_PRODUCT_FULL_VERSION_STR          :="Balong V700R110C00B060"
CFG_PRODUCT_FILE_VERSION_STR          :="2.1.6.8"
CFG_PRODUCT_DLOAD_SOFTWARE_VER		:= "21.260.00.00.00"
CFG_PRODUCT_CFG_DLOAD_KIND            :=FW_WEBUI
CFG_PRODUCT_CFG_DLOAD_ID              :=BV7R11HS
CFG_PRODUCT_CFG_DLOAD_NAME            :=P711s-HILINK
...
CFG_OS_PATH :=config/product/hi6921_v711_hilink/os
...
CFG_LNV_PRO_NAME :=hi6921_v711_hilink
...
CFG_TTF_SKB_EXP := NO
CFG_GU_FEATURE_CONFIG_PATH :=config/product/hi6921_v711_hilink/include_gu
CFG_HIFI_INCLUDE                        := NO
...
CFG_BSP_CONFIG_BOARD_HILINK := YES
...
CFG_CONFIG_CCORE_I2C := YES
CFG_CONFIG_VFP := YES
CFG_CONFIG_BALONG_DPM := YES
CFG_PRODUCT_CFG_PTABLE_VER_NAME          := "HI6921_V711_HILINK"
...
CFG_MBB_PTABLE_NVBACK_LEN               :=(0x240000)
...
CFG_MBB_PTABLE_USERDATA_LEN             :=(0x480000)
CFG_MBB_PTABLE_BBOU_LEN                 :=(0x2900000)
CFG_MBB_PTABLE_KERNEL_LEN               :=(0x600000)
CFG_MBB_PTABLE_KERNELBK_LEN             :=(0x600000)
CFG_MBB_PTABLE_LOGO_LEN                 :=(0x000000)
CFG_MBB_PTABLE_M3IMAGE_LEN              :=(0x80000)
CFG_MBB_PTABLE_DSP_LEN                  :=(0x300000)
CFG_MBB_PTABLE_MISC_LEN                 :=(0x000000)
CFG_MBB_PTABLE_VXWORK_LEN               :=(0xB00000)
CFG_MBB_PTABLE_RESERVE1_LEN             :=(0x000000)
CFG_MBB_PTABLE_RESERVE2_LEN             :=(0x000000)
CFG_MBB_PTABLE_RESERVE3_LEN             :=(0x000000)
CFG_MBB_PTABLE_OM_LEN                   :=(0x600000)
CFG_MBB_PTABLE_WEBSDK_LEN               :=(0x480000)
CFG_MBB_PTABLE_WEBUI_LEN                :=(0xF00000)
CFG_MBB_PTABLE_SYSTEM_LEN               :=(0xA80000)
...
CFG_PRODUCT_CFG_KERNEL_ENTRY 		:= 0x55108000
CFG_PRODUCT_KERNEL_PARAMS_PHYS		:= 0x55100100
...
MBB_FEATURE_SD_POLLING    :=    FEATURE_ON
MBB_FEATURE_PHY_NUM    :=    FEATURE_ON
MBB_REB    :=    FEATURE_OFF
MBB_CTF_COMMON    :=    FEATURE_OFF
MBB_FEATURE_CAT_MODULE_SET    :=    FEATURE_ON
...
MBB_POWER_KEY    :=    FEATURE_OFF
MBB_MENU_KEY    :=    FEATURE_OFF
...
MBB_FEATURE_UNI_PS_CALL    :=    FEATURE_ON
MBB_FEATURE_BIP    :=    FEATURE_ON
MBB_FEATURE_BIP_TEST    :=    FEATURE_ON
MBB_FEATURE_MPDP    :=    FEATURE_ON
MBB_FEATURE_GATEWAY    :=    FEATURE_ON
