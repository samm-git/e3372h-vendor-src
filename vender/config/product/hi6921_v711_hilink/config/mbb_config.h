...
#define    MBB_FEATURE_UNI_PS_CALL      FEATURE_ON     /* 二级宏：拨号 */
#define    MBB_FEATURE_BIP              FEATURE_ON     /* 二级宏：BIP特性 */
#define    MBB_FEATURE_BIP_TEST         FEATURE_ON     /* 二级宏：BIP特性测试宏 */
#define    MBB_FEATURE_MPDP             FEATURE_ON     /* 二级宏：MPDP特性测试宏 */
#define    MBB_FEATURE_GATEWAY          FEATURE_ON     /* 二级宏：适配网关特性测试宏 */
...
#define MBB_DLOAD_HILINK    FEATURE_ON      /*二级宏: hilink升级*/
...
#define MBB_USB_MULTICONFIG         FEATURE_ON
...
#define MBB_USB_HILINK              FEATURE_ON
