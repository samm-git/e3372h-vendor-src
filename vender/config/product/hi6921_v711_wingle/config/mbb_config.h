...
DTS2014071703821               2014-07-17          sunpeipei 00184745          增加OLED 屏特性宏
DTS2014072101153                2014-07-21        wanghaijie 00195735           适配E8372H 打开按键宏
DTS2014071400655               2014-07-25          zhaoyongjie 00182327        增加澳大利亚Telstra定制宏
*****************************************************************************************************/
...
#define    MBB_CTF_COMMON               FEATURE_OFF     /* 一级宏：CTF 暂时关闭，调试通过后打开 */
...
#define    MBB_CHG_BAT_KNOCK_DOWN       FEATURE_ON      /* 二级宏：是否可拆卸电池,FEATURE_ON:是；FEATURE_OFF:不是；不定义：不带电池 */
...
/* WiFi二级宏:该宏控制编译哪款芯片
 * 芯片目录命名规则为厂商+编号如：rtl8192, bcm43217,这是和对应的驱动目录名称要一样的。
 */
#if (FEATURE_ON == MBB_WIFI)
#define    MBB_WIFI_CHIP1     rtl8192
...
#define    MBB_TELSTRA_CUSTOMSIZE       FEATURE_ON    /* 二级宏：澳大利亚Telstra运营商定制 */
#endif
...
#define MBB_DLOAD_WINGLE    FEATURE_ON     /*二级宏:  WINGLE升级*/
...
#define MBB_USB_WINGLE              FEATURE_ON
...
#define MBB_USB_CHARGE              FEATURE_OFF
#endif
/* END: Add for PN: DTS2013070304541  by h00122846,2013/7/4 */



/*******************************************************************
           XX模块，新加宏定义者请按照本文件风格统一添加
*******************************************************************/
