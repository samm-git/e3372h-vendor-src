...
/*****************************************************************************
 结构名    : NV_PLATFORM_CATEGORY_SET_INFO
 结构说明  : 设置单板CAT等级
 结构 ID   : 50458
*****************************************************************************/
...
#endif
/*****************************************************************************
 结构名    : nv_lte_tdd_prior_info
 结构 ID   : 50527
*****************************************************************************/
#if (FEATURE_ON == MBB_WPG_COMMON)
struct nv_lte_tdd_prior_info
{
    u8 ucActiveFlag;    /*LTE_TDD优先搜网功能使能*/
    u8 ucActNum;        /*配置不保存FDD频段的个数*/
    u8  ucReserved[2];  /*对齐保留*/
    u16 usBand[32];     /*配置不保存FDD的频段的NVID*/
};
#endif
