...
typedef enum IMAGE_TYPE
{
    ...
    /*flash分区映像类型 , 这个分区包含所有需要下载升级的映像标志 */
    ...
    IMAGE_KERNER               = 0x107,     /* Kernel 分区 */
    IMAGE_KERNELBK             = 0x108,     /* Kernel 备份分区*/ 
    IMAGE_M3IMAGE              = 0x109,     /*M3 FIRMWARE 分区*/
    IMAGE_CCORE                = 0x10A,     /* MCORE VWXORKS 区 */
    IMAGE_DSP                  = 0x10B,     /* DSP 镜像 区 */
    IMAGE_LOGO                 = 0x10C,     /* LOGO 分区 */
    IMAGE_OEMINFO              = 0x10D,     /* OEMONFO 镜像 区 */
    IMAGE_SYSTEM               = 0x10E,     /* SYSTEM.IMG 镜像 区 */
    IMAGE_OM                   = 0x10F,     /* 存放可维可测数据 */
    IMAGE_WEBSDK               = 0x110,     /* APP.IMG 镜像 区 */
    IMAGE_WEBUI                = 0x111,     /* WEBUI 镜像 区 */
    IMAGE_RESERVE1             = 0x112,     /* 预留1 镜像 区 */
    IMAGE_RESERVE2             = 0x113,     /* 预留2 镜像 区 */
    IMAGE_RESERVE3             = 0x114,     /* 预留3 镜像 区 */
    IMAGE_USERDATA             = 0x115,     /* userdata 镜像 区 */
    IMAGE_BBOU                 = 0x116,     /* BBOU 在线升级 镜像 区 */
    IMAGE_MMC                  = 0x117,     /* MMC 后台 镜像区*/ 
    IMAGE_CACHE                = 0x118,     /* CACHE 镜像 区 */
    IMAGE_RECOVERY_A           = 0x119,     /* RECOVERY镜像 区  */
    IMAGE_RECOVERY_B           = 0x11A,     /* RECOVERY镜像 区  */
    IMAGE_MISC                 = 0x11B,     /* MISC 镜像 区 */
...
typedef enum IMAGE_TYPE
{
    ...
    IMAGE_RESERVE3             = 0x114,     /* 预留3 镜像 区 */
    IMAGE_USERDATA             = 0x115,     /* userdata 镜像 区 */
    IMAGE_ONLINE               = 0x116,     /* ONLINE 在线升级 镜像 区 */
    IMAGE_CDROMISO             = 0x117,     /* CDROMISO 后台 镜像区*/
    IMAGE_CACHE                = 0x118,     /* CACHE 镜像 区 */
    IMAGE_RECOVERY_A           = 0x119,     /* RECOVERY镜像 区  */
    IMAGE_RECOVERY_B           = 0x11A,     /* RECOVERY镜像 区  */
    IMAGE_MISC                 = 0x11B,     /* MISC 镜像 区 */
