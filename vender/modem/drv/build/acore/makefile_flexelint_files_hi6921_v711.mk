...
PCLINT_INC_VAR += \
	...
	-I$(BALONG_TOPDIR)/modem/drv/acore/kernel/drivers/pmic/hi6559/ \
	...
	-I$(BALONG_TOPDIR)/modem/drv/acore/kernel/drivers/net/ \
	-I$(BALONG_TOPDIR)/modem/drv/acore/kernel/drivers/net/ethernet/ \
	-I$(BALONG_TOPDIR)/modem/drv/acore/kernel/drivers/net/ethernet/stmicro/ \
	-I$(BALONG_TOPDIR)/modem/drv/acore/kernel/drivers/net/ethernet/stmicro/stmmac/ \
	...
	-I$(BALONG_TOPDIR)/modem/drv/acore/bootable/bootloader/legacy/include/balongv7r2/ \
	-I$(BALONG_TOPDIR)/modem/system/external/zarlink_api/includes \
	-I$(BALONG_TOPDIR)/modem/system/external/ \
	...
	-I$(BALONG_TOPDIR)/modem/drv/acore/kernel/drivers/modem/dialup_hsuart
#*******************************************************************
...
OBC_LOCAL_PCLINT_SRC_FILE += \
	$(BSP_DIR)/acore/kernel/drivers/modem/rtc/rtc_hi6559/rtc_hi6559.c
#/*log*/
...
#/* socp */
OBC_LOCAL_PCLINT_SRC_FILE += \
	$(BSP_DIR)/acore/kernel/drivers/modem/socp/socp_balong.c
#/*******************************************bsp1 end*******************************************/
...
#// PCIe
OBC_LOCAL_PCLINT_SRC_FILE += \
	$(BSP_DIR)/acore/kernel/drivers/pci/pcie_balong.c \
	$(BSP_DIR)/acore/kernel/drivers/pci/pcie_balong_pm.c
...
#//pmic
OBC_LOCAL_PCLINT_SRC_FILE += \
	$(BSP_DIR)/acore/kernel/drivers/pmic/hi6559/pmu_hi6559.c
OBC_LOCAL_PCLINT_SRC_FILE += \
	$(BSP_DIR)/acore/kernel/drivers/pmic/hi6559/dr_hi6559.c \
	$(BSP_DIR)/acore/kernel/drivers/pmic/hi6559/common_hi6559.c \
	$(BSP_DIR)/acore/kernel/drivers/pmic/hi6559/exc_hi6559.c \
	$(BSP_DIR)/acore/kernel/drivers/pmic/hi6559/irq_hi6559.c \
	$(BSP_DIR)/acore/kernel/drivers/pmic/hi6559/debug_hi6559.c \
...
#// slic
OBC_LOCAL_PCLINT_SRC_FILE += \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/sio.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/slic_ctl.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/snd_init.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/snd_machine.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/snd_pcm.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/snd_platform.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/snd_slic.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/spi.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/vp_hal.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/ZLR96621L_SM2_CHINA.c \
	$(BSP_DIR)/acore/kernel/sound/soc/balong/zsi.c
...
OBC_LOCAL_PCLINT_SRC_FILE += \
	...
	$(BSP_DIR)/acore/kernel/drivers/i2c/busses/hisi_i2c_designware.c
...
#//at dialup hsuart
OBC_LOCAL_PCLINT_SRC_FILE += \
	$(BSP_DIR)/acore/kernel/drivers/modem/dialup_hsuart/dialup_hsuart.c \
	$(BSP_DIR)/acore/kernel/drivers/modem/dialup_hsuart/dialup_acshell.c
#// bsp3-wangxiandong end
#/*******************************************bsp3   end*******************************************/
...
#/*gmac*/
OBC_LOCAL_PCLINT_SRC_FILE += \
	$(BSP_DIR)/acore/kernel/drivers/net/ethernet/stmicro/stmmac/stmmac_platform.c
#/*******************************************bsp4 end*******************************************/