...
#if (FEATURE_ON == MBB_USB)
	/* OTG report printer insert event here */
	usb_notify_syswatch(DEVICE_ID_USB, USB_SAMBA_PRINT_ATTACH);
#endif
...
#if (FEATURE_ON == MBB_USB)
	/* OTG report printer remove event here */
	usb_notify_syswatch(DEVICE_ID_USB, USB_SAMBA_PRINT_DETACH);
#endif
}
