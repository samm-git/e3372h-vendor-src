 ...
 * 2013-12-04 - clear coverity warning fanchangdong
 * 2013-08-21 - clear coverity warning wangzhongshun
 * 2014-02-13 - clear fortify warning chendongyue
...
{
	return 1 << (xhci_get_endpoint_index(desc) + 1);/* [false alarm]:fortify disable */
}
...
{
	return 1 << (ep_index + 1);/* [false alarm]:fortify disable */
}
...
{
	return fls(added_ctxs) - 1;/* [false alarm]:fortify disable */
}
...
int xhci_address_device(struct usb_hcd *hcd, struct usb_device *udev)
{
	...
	slot_ctx = xhci_get_slot_ctx(xhci, virt_dev->in_ctx);/* [false alarm]:fortify disable */
	/*
