/*lint -save -e34 -e63 -e578 -e573 -e52 -e831 -e413 -e132 -e101 
-e2 -e565 -e84 -e516 -e43 -e550 -e62 -e64 -e648 -e616 -e30 
-e529 -e665 -e123 -e958 -e651 -e124 -e18 -e650 -e574 
-e58 -e533 -e537 -e666 -e713 -e727 -e734 -e737 -e740 -e746 -e830*/
 ...
 * 2013-05-10 - Usb performance optimization. Zhongshun Wang, Changdong Fan<foss@huawei.com>
 *		
 */
...
static int rndis_init_response(int configNr, rndis_init_msg_type *buf)
{
	...
	resp->MaxTransferSize = cpu_to_le32(GNET_OUT_MAXSIZE_PER_TRANSFER);
#else
	resp->MaxPacketsPerTransfer = cpu_to_le32(1);
...
#else
void rndis_add_hdr(struct sk_buff *skb,int pad_len)
#endif
{
...
int rndis_rm_hdr(struct gether *port,
			struct sk_buff *skb,
			struct sk_buff_head *list, unsigned int *msg_len)
{
	unsigned int head;
	/* tmp points to a struct rndis_packet_msg_type */
	__le32 *tmp = (void *)skb->data;
	head = (unsigned int)(skb->data);
    ...
    *msg_len = le32_to_cpu(*tmp);
	GNET_TRACE(("%s: 200: MessageType, MessageLength=%d\n", __FUNCTION__,(*msg_len)));
