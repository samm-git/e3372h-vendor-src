 ...
 * Nov 6 2013 - bsp4 clear dbg info wangzhongshun 
 * Feb 13 2014 - clear fortify warning chendongyue <foss@huawei.com>
 *
...
{
	__u32 __iomem *ptr = (__u32 __iomem *) regs;
	u32 val_lo = lower_32_bits(val);/* [false alarm]:fortify disable */
	u32 val_hi = upper_32_bits(val);/* [false alarm]:fortify disable */
