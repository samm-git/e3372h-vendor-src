/*lint -save -e34 -e63 -e124 -e142 -e527 -e533 -e537 -e578 -e573 -e52 -e831 -e413 -e132 -e101 -e2 -e565 -e84 -e516 -e43 
-e550 -e62 -e64 -e648 -e616 -e30 -e529 -e665 -e123 -e958 -e651 -e124 -e18 -e650 -e539 -e718 -e730 -e732 -e734 -e740 -e744 -e738 -e746*/
/*
...
static void ecm_suspend(struct usb_function *f)
{
    ...
    if ((!ecm->curr_alt) && (!dev)) {
        GNET_INFO(("ecm function disabled, skip the ecm adapter suspend process\n"));
        return;
    }
...
ecm_bind_config(struct usb_configuration *c, u8 ethaddr[ETH_ALEN])
{
    ...
    ecm->port.fixed_in_len = GNET_IN_MAXSIZE_PER_TRANSFER;
    ecm->port.fixed_out_len = GNET_OUT_MAXSIZE_PER_TRANSFER;
#endif
