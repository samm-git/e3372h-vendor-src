 ...
 * 2014-07-28 - Add support for usb3.0 in obex_bind_config. Zhongshun Wang <foss@huawei.com>
 *
 ...
 */
int __init obex_bind_config(struct usb_configuration *c, u32 port_num)
{
	struct f_obex	*obex;
	int		status;
