...
typedef struct rndis_params
{
    USB_UINT8             confignr;
    USB_UINT8             used;
    USB_UINT16            saved_filter;
    enum rndis_state      state;
    USB_UINT32            medium;
    USB_UINT32            speed;
    USB_UINT32            media_state;

    const USB_UINT8      *host_mac;
    USB_UINT16           *filter;
    struct net_device    *dev;

    USB_UINT32            vendorID;
    const USB_CHAR       *vendorDescr;
...
USB_INT32 rndis_set_param_dev (USB_UINT8 configNr, struct net_device *dev,
             USB_UINT16 *cdc_filter);
USB_INT32 rndis_set_param_vendor (USB_UINT8 configNr, USB_UINT32 vendorID,
                const USB_CHAR *vendorDescr);
...
USB_INT32 rndis_state (USB_INT32 configNr);
extern USB_VOID rndis_set_host_mac (USB_INT32 configNr, const USB_UINT8 *addr);
