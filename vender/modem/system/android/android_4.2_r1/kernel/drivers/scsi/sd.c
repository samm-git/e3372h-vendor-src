...
#if (FEATURE_ON == MBB_USB)
	/* OTG report sd insert event here */
	usb_notify_syswatch(DEVICE_ID_SD, U_DISK_ATTATCH);
#endif
}
...
#if (FEATURE_ON == MBB_USB)
	/* OTG report sd remove event here */
	//usb_notify_syswatch(DEVICE_ID_SD, U_DISK_REMOVE);
#endif
}
