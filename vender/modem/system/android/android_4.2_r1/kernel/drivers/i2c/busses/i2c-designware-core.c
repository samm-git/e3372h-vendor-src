 ...
 * 2014-05-05 - add something function for hi6930 w00258608
 * 2014-06-25 - add a macro to ctrl hi6930 j00225808 <foss@huawei.com>
 * ----------------------------------------------------------------------------
 *
...
static void i2c_dw_dma_clear(struct dw_i2c_dev *dev)
{
	...
	dev->using_dma = false;
	dev->dmacr = 0;
	writel(dev->dmacr, dev->base + DW_IC_DMA_CR);
}
