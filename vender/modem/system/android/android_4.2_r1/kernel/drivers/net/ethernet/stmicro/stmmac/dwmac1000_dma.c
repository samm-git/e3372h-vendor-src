/*******************************************************************************
  ...
  2014-04-15 - adapted for Hisi_Balong in dwmac1000_dma_init dwmac1000_dump_dma_regs
  dwmac1000_rx_watchdog dwmac1000_dma_ops Fangyuan Liu <foss@huawei.com>.
...
/*set Rx has priority over tx, add by wangweichao*/
#define CONFIG_STMMAC_DA
			      ...
			      u32 dma_rx)
{
	...
	value = /* DMA_BUS_MODE_FB | */ DMA_BUS_MODE_4PBL |
	    ((pbl << DMA_BUS_MODE_PBL_SHIFT) |
	     (pbl << DMA_BUS_MODE_RPBL_SHIFT)) | DMA_BUS_MODE_FB;
...
static void dwmac1000_dump_dma_regs(void __iomem *ioaddr)
{
	...
	for (i = 0; i < 22; i++) {
		if ((i < 9) || (i > 17)) {
			int offset = i * 4;
			GMAC_ERR(("\t Reg No. %d (offset 0x%x): 0x%08x\n", i,
			       (DMA_BUS_MODE + offset),
