/*******************************************************************************
  ...
  2014-09-03 - adapted for Hisi_Balong Fangyuan Liu <foss@huawei.com>.
...
struct stmmac_extra_stats {
	...
	/*  gmac test    */
	unsigned long tx_desc_full;
	unsigned long enter_xmit;
	unsigned long xmit_td_full;
	unsigned long gmac_suspend;
	unsigned long gmac_release;
	unsigned long tx_avail;
	/* Receive errors */
...
struct stmmac_desc_ops {
	...
	void (*close_tx_desc) (struct dma_desc *p, int irq_enable);
    ...
    void (*dis_rx_intr_comp)(struct dma_desc *p, int disable_rx_ic);
};
