/*******************************************************************************
  ...
  2014-04-15 - adapted for Hisi_Balong in stmmac_ethtool_getsettings
  stmmac_ethtool_setsettings stmmac_set_pauseparam stmmac_set_wol
  Dongyue Chen <foss@huawei.com>.
...
static int stmmac_set_wol(struct net_device *dev, struct ethtool_wolinfo *wol)
{
	...
	if (wol->wolopts) {
		GMAC_INFO(("stmmac: wakeup enable\n"));
