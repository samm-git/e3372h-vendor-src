/*******************************************************************************
  ...
  2014-04-15 - adapted for Hisi_Balong Dongyue Chen <foss@huawei.com>.
...
typedef struct stmmac_vendor_ctx
{
    unsigned char tx_task_run;               /* tx task run */
    ...
    /* stat info */
    unsigned long stat_tx_xmit;
    unsigned long stat_tx_xmit_fail;
    unsigned long stat_tx_post;
...
struct stmmac_priv {
	...
	int hw_cap_support;
#if (FEATURE_ON == MBB_ETH_STMMAC_TX_THREAD)
    stmmac_vendor_ctx_t    vendor_ctx;
#endif
};
...
/*add by wangweichao for looptest*/
