/*******************************************************************************
  ...
  2014-06-18 - adapted for Hisi_Balong in ndesc_close_tx_desc ndesc_dis_rx_ic ndesc_ops
...
static void ndesc_close_tx_desc(struct dma_desc *p, int irq_enable)
{
...
static void ndesc_dis_rx_ic(struct dma_desc *p, int disable_rx_ic)
{
    if(disable_rx_ic)
        p->des01.rx.disable_ic = 1;
}
...
const struct stmmac_desc_ops ndesc_ops = {
    ...
    .dis_rx_intr_comp = ndesc_dis_rx_ic,
};
