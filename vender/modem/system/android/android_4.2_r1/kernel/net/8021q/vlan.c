...
#if (FEATURE_ON == MBB_CTF_COMMON)
    ctf_dev_vlan_delete(kcih, real_dev, vlan_id);
#endif

#if (FEATURE_ON == MBB_FEATURE_FASTIP)
    fastip_dev_vlan_delete(kfastip_handle, real_dev, vlan_id);
#endif
...
#if (FEATURE_ON == MBB_CTF_COMMON)
    ctf_dev_vlan_add(kcih, real_dev, vlan_id, new_dev);
#endif

#if (FEATURE_ON == MBB_FEATURE_FASTIP)
    fastip_dev_vlan_add(kfastip_handle, real_dev, vlan_id, new_dev);
#endif
	return 0;
