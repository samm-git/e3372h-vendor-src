 ...
 *
 * 2013-12-02 - add balong_memory_debug.
...
#ifdef CONFIG_BALONG_MEMORY_DEBUG
	balong_memory_debug_malloc_trace(_RET_IP_, ret, s->objsize);
#endif
...
#ifdef CONFIG_BALONG_MEMORY_DEBUG
		balong_node_debug_malloc_trace(_RET_IP_, ret, PAGE_SIZE << get_order(size));
#endif
