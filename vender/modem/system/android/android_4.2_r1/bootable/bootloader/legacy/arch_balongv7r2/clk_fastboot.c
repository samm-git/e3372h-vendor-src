...
void bsp_disable_non_on_clk(void)
{
        ...
        writel(0x1 << 4, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_01);
		 ...
		 /*ipf*/
        writel(0x1 << 8, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_01);
		...
		/*cipher*/
        writel(0x1 << 17, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_04);

        /* gmac_aclk */
        writel(1 << 22, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_04);

        /* gmac_switch_clk */
        writel(1 << 21, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_04);

        /* gmac_gtx_clk */
        writel(1 << 20, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_04);

        /* gmac_tx_clk */
        writel(1 << 19, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_04);

        /* gmac_rx_clk */
        writel(1 << 18, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_04);

        /* hifi_dbg_clk */
        writel(1 << 30, HI_SYSCRG_BASE_ADDR_VIRT + HI_CRG_DISABLE_OFFSET_03);
