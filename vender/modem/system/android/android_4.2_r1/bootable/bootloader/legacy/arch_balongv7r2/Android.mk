...
LOCAL_SRC_FILES += gpio_expander.c
endif
...
ifeq ($(strip $(CFG_CONFIG_DESIGNWARE_I2C)),YES)
LOCAL_SRC_FILES += designware_i2c.c
endif

ifeq ($(strip $(CFG_CONFIG_BALONG_I2C)),YES)
...
#oled
ifeq ($(strip $(MBB_OLED)),FEATURE_ON)
LOCAL_SRC_FILES += \
	oled_spi.c
endif
# inc
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../charge/inc
endif
ifeq ($(MBB_REB),FEATURE_ON)
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../reb_boot/
endif
