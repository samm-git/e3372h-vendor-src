...
***************************************************************/
#ifndef V711_E5_IOS_AO_CONFIG_H_
#define V711_E5_IOS_AO_CONFIG_H_

/*配置管脚复用关系、内部上下拉以及驱动能力*/
#define V711_E5_IOS_AO_CONFIG \
do{\
\
/*配置PMU(10个PIN)*/\
\
...
/*管脚配置宏for drv*/
#define V711_E5_IOS_CONFIG \
do{\
    V711_E5_IOS_AO_CONFIG;\
    V711_E5_IOS_PD_CONFIG;\
}while(0)
