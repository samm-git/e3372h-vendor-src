...
***************************************************************/
#ifndef  V711_stick_IOS_PD_SAVE_H_
#define  V711_stick_IOS_PD_SAVE_H_

/*保存掉电域管脚复用关系、内部上下拉以及驱动能力*/
#define  V711_stick_IOS_PD_CONFIG_SAVE \
do{\
\
/*配置NANDFLASH(14个PIN)*/\
\
...
\
    ...
    add_ios_list(IOS_PD_MF_CTRL4);\
    add_ios_list(IOS_PD_AF_CTRL8);\
    /*ch0_mipi_data管脚上下拉配置保存*/\
    add_ios_list(IOS_PD_IOM_CTRL60);\
\
    /*ch0_afc_pdm管脚上下拉配置保存*/\
    add_ios_list(IOS_PD_IOM_CTRL61);\
\
\
/*配置RF线控：FEM(17个PIN）*/\
    /*gpio1[15]管脚上下拉配置保存*/\
...
/*管脚配置宏for drv*/
#define  V711_stick_IOS_CONFIG_SAVE \
do{\
     V711_stick_IOS_AO_CONFIG_SAVE;\
     V711_stick_IOS_PD_CONFIG_SAVE;\
}while(0)
