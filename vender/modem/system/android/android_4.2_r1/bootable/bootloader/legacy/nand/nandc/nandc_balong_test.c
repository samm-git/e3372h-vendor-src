/*******************************************************************************
* Copyright (C), 2013-2016, HUAWEI Tech. Co., Ltd.
*
...
* Version: v1.0
*
* Filename:    testNandFlash.c
* Description: nandflash在fastboot阶段的测试函数
*
*
*******************************************************************************/
/******************************************************************************
...
* 功能描述: 测试fastboot里nandc驱动写、擦除、读相关功能
* 输入参数: 无
* 输出参数: 无
* 返 回 值: 无
...
* 功能描述: 测试fastboot里nandc驱动不带ecc读写data
* 输入参数: 无
* 输出参数: 无
* 返 回 值: 无
* 函数说明: 1、依赖于初始化、坏块查询和标记功能
...
* 功能描述: 测试fastboot里nandc驱动标记坏块功能
* 输入参数: 无
* 输出参数: 无
* 返 回 值: 无
* 函数说明: 1、坏块的标记和查询功能测试互相依赖，
*           2、step as follow
*               1 - find a good block form block 8;
*               2 - mark it bad
...
* 输出参数: 无
* 返 回 值: 无
* 函数说明: 测试fastboot里nandc驱动不带ecc读写data+oob
*******************************************************************************/
...
void nandc_test_case_029(void)
{
    ...
    for(i = 1; i <= 9; i++)
    {
        ...
        /*这里是使能ECC的读操作,错误的bit位就有可能已经纠错处理了*/
...
* 功能描述: 测试fastboot里nandc驱动bus带ecc读写data+oob，这里的操作的flash地址不是块对齐的，长度也不是快对齐的
* 输入参数: 无
* 输出参数: 无
* 返 回 值: 无
*******************************************************************************/
...
/******************************************************************************
* 函 数 名: nandc_test_case_034
* 功能描述: 测试fastboot里带ecc读写data,注意这里的flashaddr不是块对齐也不是页对齐
* 输入参数: 无
* 输出参数: 无
* 返 回 值: 无
*******************************************************************************/
