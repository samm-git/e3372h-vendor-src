...
LOCAL_C_INCLUDES += $(BALONG_TOPDIR)/include/nv/comm
...
LOCAL_STATIC_LIBRARIES += libcharge
endif

ifeq ($(strip $(MBB_LED)),FEATURE_ON)
LOCAL_STATIC_LIBRARIES += libled
endif

ifeq ($(MBB_REB),FEATURE_ON)
LOCAL_STATIC_LIBRARIES += $(TARGET_BOOTLOADER_LIBS) libreb
endif
