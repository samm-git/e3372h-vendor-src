...
******************************************************************************
File Name       :   nv_balong.c
Description     :   fastboot nv module , supply nv read interface
History         :
...
/*
 *  Function   : nv_boot_dload_info_init
 *  Discription:
 *  Parameter  : sec name
 *  Output     :
