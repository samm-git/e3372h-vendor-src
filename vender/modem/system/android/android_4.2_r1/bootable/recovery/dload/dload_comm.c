...
*   描    述 :  HDLC处理
*
*   修改记录 :  2010年11月13日  v1.00  w54542  创建
*
*************************************************************************/
...
int get_ptable_from_ram(struct ST_PART_TBL* ptable)
{
	...
	while(ret>0&&NULL!=ptable_temp)
	{
		...
		/*
			cat proc/ptable/ptable_bin 的格式为:
			image	 offset	  loadsize	     capacity   loadaddr entry	          property   count         name
			00000101 00000000 000400000 00000000 0000000 0000000000 00004000 00000000 "M3boot"
...
char* ptable_find_name_by_type(unsigned int type_id)
{
	...
	while(ret>0)
	{
		...
		/*
			cat proc/ptable/ptable_bin 的格式为:
			image	 offset	  loadsize	     capacity   loadaddr entry	          property   count         name
			00000000 00000000 000400000 00000000 0000000 0000000101 00004000 00000000 "M3boot"
