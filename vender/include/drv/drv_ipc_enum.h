...
typedef enum tagIPC_INT_LEV_E
{
   ...
   IPC_INT_DSP_RESUME                               = 4,      /*bit4,  v7r2保留，DSP通知ARM完成唤醒后的恢复操作,DSP发给CCPU的IPC中断     */
   ...
   IPC_INT_DSP_PS_PUB_MBX                           = 9,      /*bit9,  v7r2邮箱消息，PS共用邮箱中断,DSP发给CCPU的IPC中断                 */
   ...
   IPC_CCPU_INT_SRC_ACPU_MBB_COMM					=28,
#endif
