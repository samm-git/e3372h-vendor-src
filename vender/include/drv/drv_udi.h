...
#if (FEATURE_ON == MBB_COMMON)
    /* M-PDP */
    UDI_NCM_NDIS4_ID = UDI_BUILD_DEV_ID(UDI_DEV_USB_NCM, UDI_USB_NCM_NDIS4),
    UDI_NCM_NDIS5_ID = UDI_BUILD_DEV_ID(UDI_DEV_USB_NCM, UDI_USB_NCM_NDIS5),
    UDI_NCM_NDIS6_ID = UDI_BUILD_DEV_ID(UDI_DEV_USB_NCM, UDI_USB_NCM_NDIS6),
    UDI_NCM_NDIS7_ID = UDI_BUILD_DEV_ID(UDI_DEV_USB_NCM, UDI_USB_NCM_NDIS7),
#endif
