...
typedef struct
{
    BSP_U8   led_enable;        /* LED灯使能开关 */
    BSP_U8   led_dr;            /* LED灯所使用的DR */
    BSP_U8   led_mode;          /* LED灯模式标志 */
    BSP_U8   led_reserve;       /* 保留字段 */
    BSP_U32  full_on;           /* LED灯呼吸模式稳定亮的持续时间 */
    BSP_U32  full_off;          /* LED灯呼吸模式稳定暗的持续时间 */
    BSP_U32  fade_on;           /* LED灯呼吸模式从暗到亮的持续时间 */
    BSP_U32  fade_off;          /* LED灯呼吸模式从亮到暗的持续时间 */
    BSP_U32  delay_on;          /* LED灯闪烁模式亮的时间 */
    BSP_U32  delay_period;     /* LED灯闪烁模式的闪烁周期时间*/
    BSP_U32  full_long_on;     /* LED灯长亮的持续时间 */
    BSP_U32  full_long_off;    /* LED灯长暗的持续时间 */
    BSP_U32  brightness;       /* LED灯亮度电流值 */
}NV_LED_PARA_STRU;
