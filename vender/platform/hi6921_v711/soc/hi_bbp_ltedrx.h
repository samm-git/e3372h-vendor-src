...
#define    HI_BBP_LTEDRX_DRX_CFG1_OFFSET                     (0x100) /* ECO寄存器 */
#define    HI_BBP_LTEDRX_DRX_CFG2_OFFSET                     (0x104) /* ECO寄存器 */
#define    HI_BBP_LTEDRX_DRX_CFG3_OFFSET                     (0x108) /* ECO寄存器 */
#define    HI_BBP_LTEDRX_DRX_CFG4_OFFSET                     (0x10C) /* ECO寄存器 */
...
typedef union
{
    ...
    unsigned int    u32;
}HI_BBP_LTEDRX_DRX_CFG1_T;    /* ECO寄存器 */
...
typedef union
{
    ...
    unsigned int    u32;
}HI_BBP_LTEDRX_DRX_CFG2_T;    /* ECO寄存器 */
...
typedef union
{
    ...
    unsigned int    u32;
}HI_BBP_LTEDRX_DRX_CFG3_T;    /* ECO寄存器 */
...
typedef union
{
    ...
    unsigned int    u32;
}HI_BBP_LTEDRX_DRX_CFG4_T;    /* ECO寄存器 */
...
HI_SET_GET(hi_bbp_ltedrx_drx_cfg1_drx_cfg1,drx_cfg1,HI_BBP_LTEDRX_DRX_CFG1_T,HI_BBP_LTEDRX_BASE_ADDR, HI_BBP_LTEDRX_DRX_CFG1_OFFSET)
HI_SET_GET(hi_bbp_ltedrx_drx_cfg2_drx_cfg2,drx_cfg2,HI_BBP_LTEDRX_DRX_CFG2_T,HI_BBP_LTEDRX_BASE_ADDR, HI_BBP_LTEDRX_DRX_CFG2_OFFSET)
HI_SET_GET(hi_bbp_ltedrx_drx_cfg3_drx_cfg3,drx_cfg3,HI_BBP_LTEDRX_DRX_CFG3_T,HI_BBP_LTEDRX_BASE_ADDR, HI_BBP_LTEDRX_DRX_CFG3_OFFSET)
HI_SET_GET(hi_bbp_ltedrx_drx_cfg4_drx_cfg4,drx_cfg4,HI_BBP_LTEDRX_DRX_CFG4_T,HI_BBP_LTEDRX_BASE_ADDR, HI_BBP_LTEDRX_DRX_CFG4_OFFSET)
