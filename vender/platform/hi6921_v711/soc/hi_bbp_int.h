...
#define    HI_BBP_INT_PDU_SRST_EN_OFFSET                     (0x1B8) /* 寄存器。 */
#define    HI_BBP_INT_TDL_SRST_EN_OFFSET                     (0x1BC) /* 寄存器。 */
#define    HI_BBP_INT_CQI_SRST_EN_OFFSET                     (0x1C0) /* 寄存器。 */
#define    HI_BBP_INT_MISC_CTRL_OFFSET                       (0x200) /* 寄存器。 */
...
typedef union
{
    struct
    {
        ...
        unsigned int    pdu_clk_sel                : 1; /* [14..14] pdu模块时钟(pdu_clk)使能选择。0：表示不使能模块时钟；1：表示使能模块时钟；初始值为0 */
        unsigned int    tdl_clk_sel                : 1; /* [15..15] tdl模块时钟(tdl_clk)使能选择。0：表示不使能模块时钟；1：表示使能模块时钟；初始值为0 */
        unsigned int    cqi_clk_sel                : 1; /* [16..16] cqi模块时钟(cqi_clk)使能选择。0：表示不使能模块时钟；1：表示使能模块时钟；初始值为0 */
...
typedef union
{
    struct
    {
        unsigned int    pdu_com_rst_Sel            : 1; /* [0..0] pdu模块软复位信号。置1使能复位，置0清除复位。初始值为0，复位期间该模块寄存器无法访问 */
        unsigned int    Reserved                   : 31; /* [31..1]  */
    } bits;
    unsigned int    u32;
}HI_BBP_INT_PDU_SRST_EN_T;    /* 寄存器。 */

typedef union
{
    struct
    {
        unsigned int    tdl_com_rst_Sel            : 1; /* [0..0] tdl模块软复位信号。置1使能复位，置0清除复位。初始值为0，复位期间该模块寄存器无法访问 */
        unsigned int    Reserved                   : 31; /* [31..1]  */
    } bits;
    unsigned int    u32;
}HI_BBP_INT_TDL_SRST_EN_T;    /* 寄存器。 */

typedef union
{
    struct
    {
        unsigned int    cqi_com_rst_Sel            : 1; /* [0..0] cqi模块软复位信号。置1使能复位，置0清除复位。初始值为0，复位期间该模块寄存器无法访问 */
        unsigned int    Reserved                   : 31; /* [31..1]  */
    } bits;
    unsigned int    u32;
}HI_BBP_INT_CQI_SRST_EN_T;    /* 寄存器。 */

typedef union
{
    struct
    {
        unsigned int    gatedclock_en              : 1; /* [0..0] lbus_sync的自动门控使能 */
        unsigned int    Reserved_1                 : 7; /* [7..1] 保留 */
        unsigned int    arb_prior_level            : 8; /* [15..8] dma_arbiter的优先级寄存器bit[n]对应于通道[n]1表示高优先级，0表示低优先级 */
        unsigned int    Reserved_0                 : 16; /* [31..16] 保留 */
    } bits;
    unsigned int    u32;
}HI_BBP_INT_MISC_CTRL_T;    /* 寄存器。 */
...
HI_SET_GET(hi_bbp_int_clk_en_sel_pdu_clk_sel,pdu_clk_sel,HI_BBP_INT_CLK_EN_SEL_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_CLK_EN_SEL_OFFSET)
HI_SET_GET(hi_bbp_int_clk_en_sel_tdl_clk_sel,tdl_clk_sel,HI_BBP_INT_CLK_EN_SEL_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_CLK_EN_SEL_OFFSET)
HI_SET_GET(hi_bbp_int_clk_en_sel_cqi_clk_sel,cqi_clk_sel,HI_BBP_INT_CLK_EN_SEL_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_CLK_EN_SEL_OFFSET)
...
HI_SET_GET(hi_bbp_int_pdu_srst_en_pdu_com_rst_sel,pdu_com_rst_Sel,HI_BBP_INT_PDU_SRST_EN_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_PDU_SRST_EN_OFFSET)
HI_SET_GET(hi_bbp_int_pdu_srst_en_reserved,Reserved,HI_BBP_INT_PDU_SRST_EN_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_PDU_SRST_EN_OFFSET)
HI_SET_GET(hi_bbp_int_tdl_srst_en_tdl_com_rst_sel,tdl_com_rst_Sel,HI_BBP_INT_TDL_SRST_EN_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_TDL_SRST_EN_OFFSET)
HI_SET_GET(hi_bbp_int_tdl_srst_en_reserved,Reserved,HI_BBP_INT_TDL_SRST_EN_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_TDL_SRST_EN_OFFSET)
HI_SET_GET(hi_bbp_int_cqi_srst_en_cqi_com_rst_sel,cqi_com_rst_Sel,HI_BBP_INT_CQI_SRST_EN_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_CQI_SRST_EN_OFFSET)
HI_SET_GET(hi_bbp_int_cqi_srst_en_reserved,Reserved,HI_BBP_INT_CQI_SRST_EN_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_CQI_SRST_EN_OFFSET)
HI_SET_GET(hi_bbp_int_misc_ctrl_gatedclock_en,gatedclock_en,HI_BBP_INT_MISC_CTRL_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_MISC_CTRL_OFFSET)
HI_SET_GET(hi_bbp_int_misc_ctrl_reserved_1,Reserved_1,HI_BBP_INT_MISC_CTRL_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_MISC_CTRL_OFFSET)
HI_SET_GET(hi_bbp_int_misc_ctrl_arb_prior_level,arb_prior_level,HI_BBP_INT_MISC_CTRL_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_MISC_CTRL_OFFSET)
HI_SET_GET(hi_bbp_int_misc_ctrl_reserved_0,Reserved_0,HI_BBP_INT_MISC_CTRL_T,HI_BBP_INT_BASE_ADDR, HI_BBP_INT_MISC_CTRL_OFFSET)
