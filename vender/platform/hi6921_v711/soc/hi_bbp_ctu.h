...
#define    HI_BBP_CTU_C0_CH_NUM_IND_OFFSET                   (0x8) /* 从模0对应通道的指示寄存器 */
...
typedef union
{
    struct
    {
        unsigned int    c0_ch_num_ind              : 1; /* [0..0] 从模0对应的通道选择信号。0：选择通道0；1：选择通道1。配置时刻：配置时刻：各模根据通信场景配置 */
        unsigned int    c0_ch_num_ind_sel          : 1; /* [1..1] 从模0对应的通道选择信号生效方式。0：在int1生效；1：立即生效。 */
        unsigned int    reserved                   : 30; /* [31..2] 保留 */
    } bits;
    unsigned int    u32;
}HI_BBP_CTU_C0_CH_NUM_IND_T;    /* 从模0对应通道的指示寄存器 */
...
typedef union
{
    struct
    {
        unsigned int    g1_overch_inter_meas_en    : 1; /* [0..0] GSM1跨通道异频测量模式使能：1'b0：不使能1'b1：使能 */
        unsigned int    reg24_for_use              : 31; /* [31..1] 预留。 */
    } bits;
    unsigned int    u32;
...
typedef union
{
    struct
    {
        unsigned int    g2_overch_inter_meas_en    : 1; /* [0..0] GSM2跨通道异频测量模式使能：1'b0：不使能1'b1：使能 */
        unsigned int    reg25_for_use              : 31; /* [31..1] 预留。 */
    } bits;
    unsigned int    u32;
...
typedef union
{
    struct
    {
        unsigned int    ssi_unbind_en              : 1; /* [0..0] ssi通道不绑定使能：1'b0：通道绑定(双ssi)1'b1：通道不绑定(单ssi) */
        unsigned int    ssi_ch_sel0                : 1; /* [1..1] 通道0映射ssi器件关系：1'b0：通道0映射到ssi01'b1：通道0映射到ssi1 */
        unsigned int    ssi_ch_sel1                : 1; /* [2..2] 通道1映射ssi器件关系：1'b0：通道1映射到ssi01'b1：通道1映射到ssi1 */
        unsigned int    reg26_for_use              : 29; /* [31..3] 预留。 */
    } bits;
    unsigned int    u32;
...
typedef union
{
    struct
    {
        unsigned int    rf_tcvr_on_or_en           : 1; /* [0..0] 输出给RF的TCVR_ON 双通道一致使能1：任意通道的TCVR_ON拉高，则2个通道的TCVR_ON都拉高；0：根据各自通道状态拉高 */
        unsigned int    reg27_for_use              : 31; /* [31..1] 预留。 */
    } bits;
    unsigned int    u32;
...
typedef union
{
    struct
    {
        unsigned int    ch0_abb_sel_force_en       : 1; /* [0..0] 输出给ABB_CFG模块的选通信号ch1_sel_abb是否强制使能1：强制，强制值为ch0_abb_sel_force_value0：不强制，逻辑自控 */
        unsigned int    ch0_abb_sel_force_value    : 3; /* [3..1] 输出给ABB_CFG模块的选通信号ch0_sel_abb强制时的配置值 */
        unsigned int    reg28_for_use              : 28; /* [31..4] 寄存器28，预留。供DSP之间传递信息。 */
    } bits;
    unsigned int    u32;
...
typedef union
{
    struct
    {
        unsigned int    ch1_abb_sel_force_en       : 1; /* [0..0] 输出给ABB_CFG模块的选通信号ch1_sel_abb是否强制使能1：强制，强制值为ch1_abb_sel_force_value0：不强制，逻辑自控 */
        unsigned int    ch1_abb_sel_force_value    : 3; /* [3..1] 输出给ABB_CFG模块的选通信号ch1_sel_abb强制时的配置值 */
        unsigned int    reg29_for_use              : 28; /* [31..4] 预留。 */
    } bits;
    unsigned int    u32;
...
typedef union
{
    struct
    {
        unsigned int    ch0_rx_en_force_low_cnt    : 12; /* [11..0] ch0的com2abb_line_ctrl_mode切换时，com2abb_rxa/b_en强制拉低的时间。单位：总线时钟 */
        unsigned int    reg30_for_use              : 20; /* [31..12] 预留。 */
    } bits;
    unsigned int    u32;
...
typedef union
{
    struct
    {
        unsigned int    ch1_rx_en_force_low_cnt    : 12; /* [11..0] ch1的com2abb_line_ctrl_mode切换时，com2abb_rxa/b_en强制拉低的时间。单位：总线时钟 */
        unsigned int    reg31_for_use              : 20; /* [31..12] 预留。 */
    } bits;
    unsigned int    u32;
...
HI_SET_GET(hi_bbp_ctu_c0_ch_num_ind_c0_ch_num_ind,c0_ch_num_ind,HI_BBP_CTU_C0_CH_NUM_IND_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_C0_CH_NUM_IND_OFFSET)
HI_SET_GET(hi_bbp_ctu_c0_ch_num_ind_c0_ch_num_ind_sel,c0_ch_num_ind_sel,HI_BBP_CTU_C0_CH_NUM_IND_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_C0_CH_NUM_IND_OFFSET)
HI_SET_GET(hi_bbp_ctu_c0_ch_num_ind_reserved,reserved,HI_BBP_CTU_C0_CH_NUM_IND_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_C0_CH_NUM_IND_OFFSET)
...
HI_SET_GET(hi_bbp_ctu_reg24_for_use_g1_overch_inter_meas_en,g1_overch_inter_meas_en,HI_BBP_CTU_REG24_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG24_FOR_USE_OFFSET)
...
HI_SET_GET(hi_bbp_ctu_reg25_for_use_g2_overch_inter_meas_en,g2_overch_inter_meas_en,HI_BBP_CTU_REG25_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG25_FOR_USE_OFFSET)
...
HI_SET_GET(hi_bbp_ctu_reg26_for_use_ssi_unbind_en,ssi_unbind_en,HI_BBP_CTU_REG26_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG26_FOR_USE_OFFSET)
HI_SET_GET(hi_bbp_ctu_reg26_for_use_ssi_ch_sel0,ssi_ch_sel0,HI_BBP_CTU_REG26_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG26_FOR_USE_OFFSET)
HI_SET_GET(hi_bbp_ctu_reg26_for_use_ssi_ch_sel1,ssi_ch_sel1,HI_BBP_CTU_REG26_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG26_FOR_USE_OFFSET)
...
HI_SET_GET(hi_bbp_ctu_reg27_for_use_rf_tcvr_on_or_en,rf_tcvr_on_or_en,HI_BBP_CTU_REG27_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG27_FOR_USE_OFFSET)
...
HI_SET_GET(hi_bbp_ctu_reg28_for_use_ch0_abb_sel_force_en,ch0_abb_sel_force_en,HI_BBP_CTU_REG28_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG28_FOR_USE_OFFSET)
HI_SET_GET(hi_bbp_ctu_reg28_for_use_ch0_abb_sel_force_value,ch0_abb_sel_force_value,HI_BBP_CTU_REG28_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG28_FOR_USE_OFFSET)
...
HI_SET_GET(hi_bbp_ctu_reg29_for_use_ch1_abb_sel_force_en,ch1_abb_sel_force_en,HI_BBP_CTU_REG29_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG29_FOR_USE_OFFSET)
HI_SET_GET(hi_bbp_ctu_reg29_for_use_ch1_abb_sel_force_value,ch1_abb_sel_force_value,HI_BBP_CTU_REG29_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG29_FOR_USE_OFFSET)
...
HI_SET_GET(hi_bbp_ctu_reg30_for_use_ch0_rx_en_force_low_cnt,ch0_rx_en_force_low_cnt,HI_BBP_CTU_REG30_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG30_FOR_USE_OFFSET)
...
HI_SET_GET(hi_bbp_ctu_reg31_for_use_ch1_rx_en_force_low_cnt,ch1_rx_en_force_low_cnt,HI_BBP_CTU_REG31_FOR_USE_T,HI_BBP_CTU_BASE_ADDR, HI_BBP_CTU_REG31_FOR_USE_OFFSET)
