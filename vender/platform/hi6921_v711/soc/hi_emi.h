...
typedef union
{
    struct
    {
        ...
        unsigned int    reserved_2                 : 10; /* [15..6] 保留。 */
        unsigned int    dma_thrd                   : 5; /* [20..16] 门限，当dma_en==1，FIFO中剩余空间大于门限值时，req信号拉高。 */
        unsigned int    dma_en                     : 1; /* [21..21] DMA使能：1：req0：状态查询请求方式下，read_ready==1时可读，req==1时可写。状态查询方式下，read_ready==1时可读，write_ready==1时可写在所有方式下，建议采用single读 */
        unsigned int    dma_bypass                 : 1; /* [22..22] 新增DMA功能bypass1：bypass，同V7R2功能0：支持DMA功能 */
        unsigned int    gatedclock_en              : 1; /* [23..23] fifo时钟门控使能 */
        unsigned int    reserved_1                 : 2; /* [25..24]  */
...
typedef union
{
    struct
    {
        ...
        unsigned int    fifo_cnt                   : 6; /* [21..16] fifo深度 */
        unsigned int    write_ready                : 1; /* [22..22] 写允许 */
        unsigned int    read_ready                 : 1; /* [23..23] 读允许 */
        unsigned int    resp_error                 : 1; /* [24..24] 读error指示 */
...
HI_SET_GET(hi_emi_smbcr0_reserved_2,reserved_2,HI_EMI_SMBCR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBCR0_OFFSET)
HI_SET_GET(hi_emi_smbcr0_dma_thrd,dma_thrd,HI_EMI_SMBCR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBCR0_OFFSET)
HI_SET_GET(hi_emi_smbcr0_dma_en,dma_en,HI_EMI_SMBCR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBCR0_OFFSET)
HI_SET_GET(hi_emi_smbcr0_dma_bypass,dma_bypass,HI_EMI_SMBCR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBCR0_OFFSET)
HI_SET_GET(hi_emi_smbcr0_gatedclock_en,gatedclock_en,HI_EMI_SMBCR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBCR0_OFFSET)
HI_SET_GET(hi_emi_smbcr0_reserved_1,reserved_1,HI_EMI_SMBCR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBCR0_OFFSET)
HI_SET_GET(hi_emi_smbcr0_reserved_0,reserved_0,HI_EMI_SMBCR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBCR0_OFFSET)
...
HI_SET_GET(hi_emi_smbsr0_reserved_1,reserved_1,HI_EMI_SMBSR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBSR0_OFFSET)
HI_SET_GET(hi_emi_smbsr0_fifo_cnt,fifo_cnt,HI_EMI_SMBSR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBSR0_OFFSET)
HI_SET_GET(hi_emi_smbsr0_write_ready,write_ready,HI_EMI_SMBSR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBSR0_OFFSET)
HI_SET_GET(hi_emi_smbsr0_read_ready,read_ready,HI_EMI_SMBSR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBSR0_OFFSET)
HI_SET_GET(hi_emi_smbsr0_resp_error,resp_error,HI_EMI_SMBSR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBSR0_OFFSET)
HI_SET_GET(hi_emi_smbsr0_reserved_0,reserved_0,HI_EMI_SMBSR0_T,HI_EMI_REGBASE_ADDR, HI_EMI_SMBSR0_OFFSET)

/* EMI DMA enable */

static __inline__ void hi_emi_dma_enable(void)
{
    set_hi_emi_smbcr0_dma_en(1);
}

static __inline__ void hi_emi_gateclock_enable(void)
{
    set_hi_emi_smbcr0_gatedclock_en(1);
}

static __inline__ void hi_emi_set_bypass(void)
{
    set_hi_emi_smbcr0_dma_bypass(1);
}

static __inline__ void hi_emi_support_dma(void)
{
    set_hi_emi_smbcr0_dma_bypass(0);
}

static __inline__ unsigned int hi_emi_fifo_cnt(void)
{
    return get_hi_emi_smbsr0_fifo_cnt();
}
